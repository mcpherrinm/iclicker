...
//PKTParam section not used in buffered mode
...
// IRQ Param 1
// Select RX&STDBY IRQ_0 sources (Buffered mode)
#define RF_IRQ0_RX_STDBY_OFF             0x00
#define RF_IRQ0_RX_STDBY_WRITEBYTE       0x40
#define RF_IRQ0_RX_STDBY_FIFOEMPTY       0x80
#define RF_IRQ0_RX_STDBY_SYNC            0xC0

// Select RX&STDBY IRQ_1 sources (Buffered mode)
#define RF_IRQ1_RX_STDBY_OFF             0x00
...
// FIFO filling flag/control
#define RF_IRQ2_FIFOFILL_FLAGCTRL_0      0x00
#define RF_IRQ2_FIFOFILL_FLAGCTRL_1      0x40

// Select TX start condition and IRQ_0 source (Buffered mode)
#define RF_IRQ0_TX_FIFOEMPTY_START_FIFOFULL     0x00
...
// Bit synchronizer
// Automatically activated in Buffered mode
