...
_U16 RegistersCfg[] = { // SX1211 configuration registers values
		...
		DEF_BITRATE | RF_BITRATE_100000,                       
		DEF_OOKFLOORTHRESH | RF_OOKFLOORTHRESH_VALUE,                  
		DEF_MCPARAM6 | RF_MC6_FIFO_SIZE_16 | RF_MC6_FIFO_THRESH_VALUE,                   
		DEF_R1 | 143,                            
		DEF_P1 | 114,                            
		DEF_S1 | 65,                            
		DEF_R2 | RF_R2_VALUE,                            
		...
		DEF_IRQPARAM1 | RF_IRQ0_RX_STDBY_OFF | RF_IRQ1_RX_STDBY_OFF | RF_IRQ1_TX_FIFOFULL,                     
		DEF_IRQPARAM2 | RF_IRQ2_FIFOFILL_METHOD_AUTO | RF_IRQ2_FIFOFILL_FLAGCTRL_0 | RF_IRQ0_TX_FIFOEMPTY_START_FIFOFULL | RF_IRQ2_PLL_LOCK_PIN_ON,                     
