...
*******************************************************************/
#ifndef __SX1231DRIVER__
#define __SX1231DRIVER__
...
*******************************************************************/
#define RF_BUFFER_SIZE_MAX   66  // Limited in this API implementation but SX1231 itself allows up to infinite packet length
...
**                                  *  uC     * SX1231    * PAx   **
*******************************************************************/
#define DIO1            0x02      //*  In     *  Out      * PA1 // DCLK (Rx/Tx)
#define DIO0            0x08      //*  In     *  Out      * PA3 // 
...
**                                  *  uC     * SX1231    * PCx   **
*******************************************************************/
#define DATA            0x01      //*  Out/In *  In/Out   * PC0 // DATA (Rx/Tx)
...
#define SPINss(level) 		 ((level) ? (PORTO |= NSS) : (PORTO &= ~NSS))
...
//#define RF_BITRATEMSB_153600                        0x00 // Not supported by API in continuous mode (CPU speed limitation)
//#define RF_BITRATELSB_153600                        0xD0 //
#define RF_BITRATEMSB_57600                         0x02
#define RF_BITRATELSB_57600                         0x2C
//#define RF_BITRATEMSB_115200                        0x01 // Not supported by API in continuous mode (CPU speed limitation)
...
//#define RF_BITRATEMSB_200000                        0x00 // Not supported by API in continuous mode (CPU speed limitation)
