...
**                                  *  uC     * XE1205    * PAx   **
*******************************************************************/
#define IRQ_1           0x02      //*  In     *  Out      * PA1 // DCLK
//#define DATA            0x04      //*  In     *  Out      * PA2 // DATAOUT
//#define IRQ_0           0x08      //*  In     *  Out      * PA3 // Pattern
#define DATA            0x01      //*  In     *  Out      * PA0 // DATAOUT
#define IRQ_0           0x10      //*  In     *  Out      * PA4 // Pattern
...
**                                  *  uC     * XE1205    * PCx   **
*******************************************************************/
#define NSS_DATA        0x01      //*  Out     *  In      * PC0 // DATAIN
#define SW1             0x02      //*  In      *  Out     * PC1 // TX
#define SW0             0x04      //*  In      *  Out     * PC2 // RX
...
#define REG_MCPARAM4                     0x03 // LO MSB
#define REG_MCPARAM5                     0x04 // LO LSB
...
#define DEF_MCPARAM4                     0x00 // LO MSB
#define DEF_MCPARAM5                     0x00 // LO LSB
