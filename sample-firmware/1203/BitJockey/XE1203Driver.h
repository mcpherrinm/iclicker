...
**                                  *  uC     * XE1203    * PBx   **
*******************************************************************/
#define TX              0x10      //*  Out    *  In       * PB4
#define RX              0x20      //*  Out    *  In       * PB5
...
**                                  *  uC     * XE1203    * PDx   **
*******************************************************************/
#define DATA            0x01      //*  In     *  Out      * PD0
#define DCLK            0x02      //*  In     *  Out      * PD1
#define PATTERN         0x04      //*  In     *  Out      * PD2
...
#define RF_AD2_RES_X_OSC_3800_0  0x00
